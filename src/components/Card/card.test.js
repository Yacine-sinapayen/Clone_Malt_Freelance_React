...
// Je vais vérifier que mon composant render bien sasn crasher
describe('Card component', () => {
     ...
     // Je vérifie que mon composant reçoi bien la prop {title}
     ...
     test('should render title and image', async () => {
          ...
          // La regex passé à getBytext(/Harry/i)signifie que la recherche est insensible à la casse pour le mot "Harry".
     ...
     test('Should add ⭐️ around title', async () => {
          ...
          // 2 - Je récupère le parent la div parent la plus proche de mon titre grace à 'closest'.
          // 3 - Je lance l'event 'clic' dessus
          // 4 - Et je dis ce que j'attend en suite à cet event
