...
/* test('Should render without crash'
    1 - L'ancienne syntaxe :
        ...
        Nous oblige à importer 'ThemeProvider' dans tous nos tests. Afin d'avoir une syntaxe plus élégante nous avons créé un 'Wrapper' daans 'utils/test/index.js' ce qui permet la syntaxe suivante : cd code

    2 - waitForElementToBeRemoved est plus adapté à notre code que l'ancienne version de cette ligne :
        'expect(screen.getByTestId('loader')).toBeTruthy();'
        car en plus de vérifier que notre 'loader' s'affiche bien et va attendre qu'il disparaisse pour passer à la suite du code ce qui correspond parfaitement au comportement attendu dans mon composant 'Freelances'. Si je vais dans mon composant et que je commente le ternaire 'isloading' mon loader sera tout le temps affocher et donc mon test va crasher.
