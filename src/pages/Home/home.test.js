...
describe('The Home component', () => {
    // je test que mon composant render sans crasher, je n'oubli pas de le wrapper avec un 'MemoryRouter' si j'utilise react-router-dom et aussi avec 'ThemeProvider' lorsqeu j'utilise un context.
    ...
    it('should render title', () => {
        ...
        // screen.debug()
        // Grace à la ligne ci-dessus j'ai pu récupérer le contenu de mon H2 et vérifier le test ci-dessous.
        expect(screen.getByText('Repérez vos besoins, on s’occupe du reste, avec les meilleurs talents')).toBeTruthy()

        // On va pousser notre test un peu plus loin en vérifiant à le fois le rôle (h2,h3 etc) et le contenu. 'Level : 3' <=> 'h2'
